...
public class Practice14GetFontMetricsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float textY = middle + baseline;
        canvas.drawText(texts[0], 100, textY, paint2);
        canvas.drawText(texts[1], 200, textY, paint2);
        canvas.drawText(texts[2], 300, textY, paint2);
        canvas.drawText(texts[3], 400, textY, paint2);
        canvas.drawText(texts[4], 500, textY, paint2);
        canvas.drawText(texts[5], 600, textY, paint2);
    }
}
